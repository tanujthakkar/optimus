...
# Code by Tanuj Thakkar (UID 117817539)
# Submitted as Homework 4 for ENPM662 Introduction to Robot Modeling
...
def main():
    ...
    for i in range(circ_pts):
        ...
        pub_front_shouler_pan.publish(q_curr[0])
        pub_front_shouler_lift.publish(q_curr[1])
        pub_front_elbow.publish(q_curr[2])
        pub_front_shouler_wrist_1.publish(q_curr[3])
        pub_front_shouler_wrist_2.publish(q_curr[4])
        pub_front_shouler_wrist_3.publish(q_curr[5])

        pub_rear_shouler_pan.publish(q_curr[0])
        pub_rear_shouler_lift.publish(q_curr[1])
        pub_rear_elbow.publish(q_curr[2])
        pub_rear_shouler_wrist_1.publish(q_curr[3])
        pub_rear_shouler_wrist_2.publish(q_curr[4])
        pub_rear_shouler_wrist_3.publish(q_curr[5])
